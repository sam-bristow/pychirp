...
_SCATTERMESSAGE = _descriptor.Descriptor(
  name='ScatterMessage',
  full_name='chirp_0000040d.ScatterMessage',
  filename=None,
  file=DESCRIPTOR,
...
_GATHERMESSAGE = _descriptor.Descriptor(
  name='GatherMessage',
  full_name='chirp_0000040d.GatherMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='chirp_0000040d.GatherMessage.value', index=0,
...
_PUBLISHMESSAGE = _descriptor.Descriptor(
  name='PublishMessage',
  full_name='chirp_0000040d.PublishMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='chirp_0000040d.PublishMessage.value', index=0,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ScatterMessage = _reflection.GeneratedProtocolMessageType('ScatterMessage', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:chirp_0000040d.ScatterMessage)
  ))
...
GatherMessage = _reflection.GeneratedProtocolMessageType('GatherMessage', (_message.Message,), dict(
  ...
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:chirp_0000040d.GatherMessage)
  ))
...
PublishMessage = _reflection.GeneratedProtocolMessageType('PublishMessage', (_message.Message,), dict(
  ...
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:chirp_0000040d.PublishMessage)
  ))
