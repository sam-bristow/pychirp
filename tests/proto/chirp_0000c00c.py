...
_SCATTERMESSAGE = _descriptor.Descriptor(
  name='ScatterMessage',
  full_name='chirp_0000c00c.ScatterMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='chirp_0000c00c.ScatterMessage.value', index=0,
...
_GATHERMESSAGE = _descriptor.Descriptor(
  name='GatherMessage',
  full_name='chirp_0000c00c.GatherMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='chirp_0000c00c.GatherMessage.value', index=0,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PUBLISHMESSAGE = _descriptor.Descriptor(
  name='PublishMessage',
  full_name='chirp_0000c00c.PublishMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='chirp_0000c00c.PublishMessage.value', index=0,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ScatterMessage = _reflection.GeneratedProtocolMessageType('ScatterMessage', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:chirp_0000c00c.ScatterMessage)
  ))
...
GatherMessage = _reflection.GeneratedProtocolMessageType('GatherMessage', (_message.Message,), dict(
  ...
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:chirp_0000c00c.GatherMessage)
  ))
...
PublishMessage = _reflection.GeneratedProtocolMessageType('PublishMessage', (_message.Message,), dict(
  ...
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:chirp_0000c00c.PublishMessage)
  ))
_sym_db.RegisterMessage(PublishMessage)


# @@protoc_insertion_point(module_scope)
ScatterMessage.SIGNATURE = 0x0000c00c
GatherMessage.SIGNATURE = 0x0000c00c
PublishMessage.SIGNATURE = 0x0000c00c
